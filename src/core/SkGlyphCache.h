...
public:
    ...
    */
...
#ifdef REVERIE
    uint16_t * unicharsToGlyphs(SkUnichar *charCode, uint32_t no_of_charcodes,
    ...
    uint16_t * unicharsToSyllableEnds(SkUnichar *charCode, uint32_t no_of_charcodes,
            uint32_t *no_of_syllableEnds);
#endif
